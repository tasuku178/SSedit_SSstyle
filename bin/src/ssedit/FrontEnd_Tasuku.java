...
//	JTextField folderPath_textField1 = new JTextField();
    ...
    JCheckBox panel_option = new JCheckBox();
    boolean succeed;
    ...
    class execThread_Tasuku extends SwingWorker<Object, Object> {
        ...
        public Object doInBackground() {
            ...
            if (SSQL_exec_Tasuku.execSuperSQL(filename, libsClassPath, GlobalEnv.resultPane, GlobalEnv.resultDoc)) {
                ...
                ssqlExecLogs += "### レイアウト処理 失敗 ###" + GlobalEnv.OS_LS + "";
                try {
                    GlobalEnv.resultDoc.insertString(GlobalEnv.resultDoc.getLength(), "### レイアウト処理 失敗 ###" + GlobalEnv.OS_LS + "", CaretState.errAttr);
                } catch (BadLocationException e) {
                    e.printStackTrace();
                }
            }
